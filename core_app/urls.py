...
urlpatterns = [
    ...
    path("showthemes/<int:pk>/delete", show_themes_delete, name="showthemes-delete"),
    ...
    path(
        "showsessions/create",
        ShowSessionsCreateView.as_view(),
        name="showsessions-create",
    ),
    path(
        "showsessions/<int:pk>/update",
        ShowSessionsUpdateView.as_view(),
        name="showsessions-update",
    ),
    path(
        "showsessions/<int:pk>/delete",
        ShowSessionsDeleteView.as_view(),
        name="showsessions-delete",
    ),
    ...
    path(
        "planetariumdomes/create",
        PlanetariumDomeCreateView.as_view(),
        name="planetariumdomes-create",
    ),
    path(
        "planetariumdomes/<int:pk>/update",
        PlanetariumDomeUpdateView.as_view(),
        name="planetarium_dome-update",
    ),
    path(
        "planetariumdomes/<int:pk>/delete",
        PlanetariumDomeDeleteView.as_view(),
        name="planetarium_dome-delete",
    ),
    path(
